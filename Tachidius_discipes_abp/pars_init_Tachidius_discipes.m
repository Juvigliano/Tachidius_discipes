...
par.T_AL = 25000;     free.T_AL  = 0;   units.T_AL = 'K';         label.T_AL = 'Arrhenius temperature low boundary'; 
par.T_L = 278;        free.T_L   = 0;   units.T_L = 'K';          label.T_L = 'Lower temperature boundary for optimal growth';
%par.T_AH = 20000;     free.T_AH  = 0;   units.T_AH = 'K';         label.T_AH = 'Arrhenius temperature high boundary'; 
%par.T_H = 300;        free.T_H   = 0;   units.T_H = 'K';          label.T_H = 'Higher temperature boundary for optimal growth'; 
