...
data.tL15 = [t_data, Lmean]; % d, cm- time, mean length
...
stdev.tL15 =Lsd ; units.stdev.tL15 = 'cm'; label.stdev.tL24 = 'standard deviation';
...
xlabel('Time (days)');
ylabel('Length (cm)');
title('Model Predictions for Different f Values at 15  C');
legend('show');
hold on
