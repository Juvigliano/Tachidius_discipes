%% get_pars_8
% Obtains 8 DEB parameters from 8 data points at abundant food
...
function par = get_pars_8(data, fixed_par, chem_par)
  ...
  % See <iget_pars_8.html *iget_pars_8*> for the inverse mapping and 
  ...
  %% Example of use
  %  See <../mydata_get_par_8.m *mydata_get_par_8>
