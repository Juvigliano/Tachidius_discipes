...
T    =   297.15; % K, actual body temperature
T_ref  = 297.15; % K, temp for which rate pars are given 

T_A  =   4000.72; % K, Arrhenius temp
...
n_O = [1.00, 1.00, 1.00, 1.00;  % C/C, equals 1 by definition
       1.80, 1.80, 1.8, 1.80;  % H/C
       0.50, 0.50, 0.5, 0.50;  % O/C
...
d_O = [.17; .17; .17; .17];     % g/cm^3, specific densities for organics
...
z = 0.052036;       % zoom factor rel to reference L_m = 1 cm to compare species
del_M = 1.3533; % -, shape coefficient to convert vol-length to physical length
